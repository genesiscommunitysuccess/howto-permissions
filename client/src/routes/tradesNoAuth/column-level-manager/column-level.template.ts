...
import type { TradesNoAuthColumnLevelManager } from './column-level';
...
export const ColumnLevelTemplate = html<TradesNoAuthColumnLevelManager>`
    ${whenElse(
