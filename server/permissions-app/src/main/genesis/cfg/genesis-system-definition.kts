systemDefinition {
    global {
        ...
        item(name = "DbHost", value = "jdbc:h2:file:~/genesis-local-db/permissions/h2/test;DB_CLOSE_DELAY=-1;NON_KEYWORDS=VALUE,KEY;AUTO_SERVER=TRUE")
        item(name = "DbQuotedIdentifiers", value = true)
        item(name = "DEPLOYED_PRODUCT", value = "permissions")
    ...
    systems {
        ...
        system(name = "DEV") {
            ...
            item(name = "DbNamespace", value = "permissions")
